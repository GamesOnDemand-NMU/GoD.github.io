<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Friends.aspx.cs" Inherits="G2G.Friends" %>
                  ...
                  <a class="navbar-brand" href="#"><img src="images/ProductLogo.png" class="logo-nav" alt="Game2Gether logo"/></a><!--Logo -->
                   <ul class="navbar-nav active align-items-start">
                        <li class="nav-item dropdown float-lg-left">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Friends</a><!--Current Page-->
