<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebsiteRankings.aspx.cs" Inherits="G2G.WebsiteRankings" %>
...
<body>
    <form id="WebsiteRankings" runat="server">
            <!--Start of navbar-->  
                  ...
                  <a class="navbar-brand" href="#"><img src="images/ProductLogo.png" class="logo-nav" alt="Game2Gether logo"/></a><!--Logo -->
                   <ul class="navbar-nav active align-items-start">
                        <li class="nav-item dropdown float-lg-left">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Rankings</a><!--Current Page-->
            ...
            <div class="container h-100 d-block" style="padding-top: 5em;">
                <div class="row">
                    <div class="col-md-6 pt-2">
                        <div class="container bg-g2g rounded pt-2">
                            <h1>Top Rated Players</h1>
                            <hr/>

                            <ul id="lstTopPlayers" class="list-group">
                                <li class="list-group-item">Test Player <i class="far fa-plus-square float-right pr-2 pr-2 pt-1"></i> 
                                                                        <i class="fas fa-user-plus float-right  pr-2 pr-2 pt-1"></i> 
                                                                        <i class="fas fa-star float-right pr-2 pr-2 pt-1"></i></li>
                            </ul>
                        </div>
                    </div>
                    <br />
                    <div class="col-md-6 pt-2">
                        <div class="container bg-g2g rounded pt-2">
                            ...
                            <hr/>
                            <ul id="lstTopGames" class="list-group">
                                <li class="list-group-item">Test Game <i class="fas fa-star float-right pr-2 pr-2 pt-1"></i></li>
                            </ul>
                        </div>
                    </div>
                </div>
